...
public abstract class SalableProduct {
	...
	/**
	 * This method is a variant of compareTo for the price attributes
	 * @param product
	 * @return int
	 */
	public int priceCompareTo(SalableProduct product) {
		return (int) (this.get_price()-product.get_price());
	}
